      ...
      {show && (
        ...
        >
          <img
            ...
            alt='logo'
            className={clsxm(
              'absolute top-0 bottom-[25%] m-auto h-[18%] max-h-[130px] w-[35%] max-w-[250px]'
            )}
          />
          <GradientButton
            onClick={() => setShow(!show)}
            className='flex w-[70%] max-w-[310px] items-center justify-center'
          >
            Get Started
          </GradientButton>
          <h1 className='mt-[5%] text-center font-comfortaa text-[1rem] font-[300] leading-5 text-goldAccent'>
